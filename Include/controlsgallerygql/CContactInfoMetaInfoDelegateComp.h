...
protected:
	...
	virtual bool FillRepresentation(
				...
				const idoc::IDocumentMetaInfo& metaInfo) const override;
	virtual bool FillMetaInfo(
				idoc::IDocumentMetaInfo& metaInfo,
				const sdl::controlsgallery::ContactInfos::CContactInfoItemData::V1_0& metaInfoRepresentation) const override;
};
